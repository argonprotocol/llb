          ...
          <TransitionChild as="template" enter="ease-out duration-300" enter-from="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95" enter-to="opacity-100 translate-y-0 sm:scale-100" leave="ease-in duration-200" leave-from="opacity-100 translate-y-0 sm:scale-100" leave-to="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95">
            ...
            <DialogPanel class="relative transform rounded-lg bg-white px-3 pb-3 pt-3 text-left shadow-xl transition-all w-full max-w-3xl">
              ...
              <div class="flex flex-col divide-y text-center">
                <a class="block py-5 outline-none" href="https://argonprotocol.org/the-state-of-collateral-backed-stablecoins.pdf" target="_blank">
                ...
                <a class="block py-5 outline-none" href="https://argonprotocol.org/fundamentals-for-creating-a-truly-stable-asset.pdf" target="_blank">
                  <div class="text-lg font-bold">Fundamentals for Creating a Truly Stable Asset</div>
                  <div class="text-sm text-slate-400">By Caleb Clark and Blake Byrnes</div>
                </a>
                <a disabled class="block py-5 outline-none" href="https://argonprotocol.org/bootstrapping-a-currency-from-zero-to-global.pdf" target="_blank">
