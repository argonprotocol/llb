      ...
      <div class="fixed inset-0 z-50 w-screen overflow-y-auto">
        <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
          <TransitionChild as="template" enter="ease-out duration-300" enter-from="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95" enter-to="opacity-100 translate-y-0 sm:scale-100" leave="ease-in duration-200" leave-from="opacity-100 translate-y-0 sm:scale-100" leave-to="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95">
            ...
            <DialogPanel data-dialog-panel class="relative transform rounded-lg bg-white px-5 pb-3 pt-3 text-left shadow-xl transition-all w-full max-w-3xl my-6">
              ...
              <div class="divide-y px-1 sm:px-4 overflow-y-auto max-h-[65vh]">
                ...
                <details class="py-4">
                  ...
                  <div class="space-y-3 pt-3 text-base text-gray-500 cursor-default">
                    <p>Choose when to lock and unlock your bitcoin, then compare the results. Add an Argon price drop to explore what happens if Argon falls below its target price<template v-if="desktop">, or choose <strong>Take Our Guided Tour</strong> from the More Info menu for a walkthrough</template>.</p>
                  </div>
                </details>
