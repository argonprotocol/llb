            ...
            <DialogPanel class="relative transform rounded-lg bg-white px-5 pb-3 pt-3 text-left shadow-xl transition-all w-full max-w-3xl my-6">
              ...
              <div class="divide-y px-1 sm:px-4 overflow-y-auto max-h-[65vh]">
                ...
                <details class="py-4">
                  ...
                  <div class="space-y-3 pt-3 text-base text-gray-500 cursor-default">
                    <p>Choose when to lock and unlock your bitcoin, then compare the results. Add an Argon price drop to explore what happens if Argon falls below its $1 target, or choose <strong>Take Our Guided Tour</strong> from the More Info menu for a walkthrough.</p>
                  </div>
                </details>
                ...
                <details class="py-4">
                  ...
                  <div class="space-y-3 pt-3 text-base text-gray-500 cursor-default">
                    <p>The model combines Bitcoin price changes with Liquid Locking’s hedging mechanism and opportunities to buy back Argon below its $1 target. Results depend on your selected dates and settings; they are simulated outcomes, not promised returns.</p>
                  </div>
                </details>
                ...
                <details class="py-4">
                  ...
                  <div class="space-y-3 pt-3 text-base text-gray-500 cursor-default">
                    <p>For gains from an Argon price drop, the other side of the trade is whoever sells Argon below its $1 target. Buying it back at that lower price reduces the cost of unlocking your bitcoin.</p>
                  </div>
                </details>
                ...
                <details class="py-4">
                  ...
                  <div class="space-y-3 pt-3 text-base text-gray-500 cursor-default">
                    ...
                    <p>For example, drag the date sliders to include February 14–March 13, 2020, when Bitcoin fell roughly 53% in under a month. To test a 99.9% Argon plunge, add a price drop to $0.001 in your configuration.</p>
                  </div>
                </details>
              </div>
